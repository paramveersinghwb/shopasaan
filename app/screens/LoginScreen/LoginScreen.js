...
loginApiResponse = (response,token) => {
  ...
  render() {
    ...
    />
          ...
          <Text style = {{color:'#FF6E40',fontSize:14,fontWeight:'600',alignSelf:'flex-end',marginTop:5}}>Forget password</Text>

          </TouchableOpacity>

  <View style = {styles.bottomView}>
            <Text style = {{fontSize:16,fontWeight:'600',marginBottom:5}}>Don't have account?</Text>
            <TouchableOpacity onPress = {()=>this.onSignUp()}>
            <Text style = {{color:'#FF6E40',fontSize:14,fontWeight:'600',}}>Create new account</Text>
            </TouchableOpacity>
