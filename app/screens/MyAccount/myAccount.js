        ...
        return (
            <SafeAreaView style={{ flex: 1 }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 20,marginBottom: 20, }}>
                        ...
                        <Text style={{ textAlign: 'center', flex: 1, marginRight: 20, fontSize: 24,fontWeight: '600', }}>My Account</Text>
                    </View>
          ...
          />
          <TouchableOpacity style = {{alignItems:'center',marginLeft:10}} onPress = {()=> this.setState({PhoneNumber:true})}>
          ...
          />
          <TouchableOpacity style = {{alignItems:'center',marginLeft:10}} onPress = {()=> this.setState({email:true})}>
              <Text style = {{color:'black',fontSize:14,textAlign:'center'}}>
              Edit
          ...
          <View style = {{borderWidth:1,marginTop: wp("5%"),paddingBottom:10,marginHorizontal:10}}>
            <Text style = {{marginLeft:20,fontSize:16,fontWeight:'600',marginVertical: 10,}}> Address</Text>
          ...
          />
            ...
            propStyle={{ marginTop: wp("5%"),width:wp('90%'),alignSelf:'center' }}
            value={this.state.contactNumber}
            onChangeText={value =>this.setState({contactNumber:value})}
          />
                    <View style = {{flexDirection:'row',justifyContent:'center',marginTop: wp("5%"),marginLeft:10}}>
                    <RoundCornerTextInput
            placeholder="City"
          ...
          />
              <RoundCornerTextInput
            placeholder="State"
            propStyle={{width:wp('45%'),alignSelf:'center',marginLeft:5 }}
            value={this.state.contactNumber}
            onChangeText={value =>this.setState({contactNumber:value})}
          />
          </View>
...
<TouchableOpacity>
    <Text style = {{textDecorationLine: 'underline',fontWeight:'600',color:'##00BEDA',fontSize:15}}>
        Change password
    </Text>
</TouchableOpacity>
...
<TouchableOpacity>
    <Text style = {{textDecorationLine: 'underline',fontWeight:'600',color:'##00BEDA',fontSize:15}}>
        Delete Account
          ...
          <View style = {{flexDirection:'row',justifyContent:'center',marginVertical: wp("10%"),}}>
