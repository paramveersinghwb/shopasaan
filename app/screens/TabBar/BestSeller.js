    ...
    render() {
        ...
        return (
            ...
            <View style = {{flex:1,justifyContent:'center',alignItem:'center'}}>
                ...
                <TouchableOpacity>
                <View style={{ borderRadius: 5, borderWidth: 1,justifyContent:'center',alignItem:'center',flex:1,marginRight:10,width:90 }}>
                        <Text style={{ color: 'black', fontSize: 18,textAlign:'center' }}>ADD</Text>
                    </View>
                </TouchableOpacity>
            </View>
            ...
            <View style = {{justifyContent:'center',alignItem:'center',marginRight:10}}>
                <NumericInput 
