import { EmailBlankMsg, EmailErrMsg, PassBlankMsg, NameBlankMsg, NameErrMsg, ConfirmPassMsg, ConfirmPassMatchMsg, PasswordLengthMsg } from '../assets/default_text';
...
export function validatePassword(data) { // validation for password
    ...
    else if(data.length < 8) return {status: false, message: PasswordLengthMsg}
    else return { status: true, message: '' }
}
